...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function createPhotoField(value, rowIndex) {
    ...
    actions.append(
      photoChoiceButton("camera", "bi-camera", "Ambil Dari Kamera", statusId),
      photoChoiceButton("gallery", "bi-images", "Pilih Dari Galeri", statusId)
    );
  ...
  function photoChoiceButton(source, icon, label, statusId) {
...
<worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006" mc:Ignorable="x14ac" xmlns:x14ac="http://schemas.microsoft.com/office/spreadsheetml/2009/9/ac"><dimension ref="A1:C${lastRow}"/><sheetViews><sheetView workbookViewId="0"/></sheetViews><sheetFormatPr defaultRowHeight="15"/><sheetData>${rows.join("")}</sheetData></worksheet>`;
  }
...
<Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties" xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes"><Application>Microsoft Excel</Application><DocSecurity>0</DocSecurity><ScaleCrop>false</ScaleCrop><HeadingPairs><vt:vector size="2" baseType="variant"><vt:variant><vt:lpstr>Worksheets</vt:lpstr></vt:variant><vt:variant><vt:i4>2</vt:i4></vt:variant></vt:vector></HeadingPairs><TitlesOfParts><vt:vector size="2" baseType="lpstr"><vt:lpstr>Survey</vt:lpstr><vt:lpstr>DocumentationData</vt:lpstr></vt:vector></TitlesOfParts><Company>Perkom Indah Murni</Company><LinksUpToDate>false</LinksUpToDate><SharedDoc>false</SharedDoc><HyperlinksChanged>false</HyperlinksChanged><AppVersion>16.0300</AppVersion></Properties>`,
  ...
  function googleNotificationHtml(data) {
    ...
    return [
      ...
      '<img src="https://perkom-portal.vercel.app/assets/images/perkom-loading.png" width="168" height="66" alt="Perkom" style="display:block;width:168px;max-width:100%;height:auto;margin-left:-60px;border:0;outline:none;text-decoration:none;">',
      '</td>',
